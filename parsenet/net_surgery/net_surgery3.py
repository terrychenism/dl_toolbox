...
net = caffe.Net('../models/VGGNet/8conv3fc_DSN_fc_deploy3.prototxt',
    '../models/VGGNet/8conv3fc_DSN_ImageNet.caffemodel', caffe.TEST)
...
net_full_conv = caffe.Net('../models/VGGNet/8conv3fc_DSN_conv_deploy3.prototxt', caffe.TEST)
...
net_full_conv.save('../models/VGGNet/8conv3fc_DSN_ImageNet_conv.caffemodel')

print 'finish net surgery'