...
def pascal_context_to_lmdb(dir_imgs,
    ...
    paths_imgs = [] #os.listdir(dir_imgs)

    paths_segm_labels = os.listdir(dir_segm_labels)
     
    #paths_pairs = fs.fname_pairs(paths_imgs, paths_segm_labels)    
    #paths_imgs, paths_segm_labels = map(list, zip(*paths_pairs))
    
    for fileName in paths_segm_labels:

        new_filename = fileName.rsplit( ".", 1 )[ 0 ] + '.jpg'
        paths_imgs.append(new_filename)
...
def main(args):
    ...
    val_list_path = '/home/tairuichen/Documents/PASCAL-Context/val_59.txt'
    ...
    pascal_context_to_lmdb('/home/tairuichen/Documents/PASCAL-Context/VOC2010/JPEGImages/',
                           '/home/tairuichen/Documents/PASCAL-Context/trainval/',
                           '/home/tairuichen/Documents/PASCAL-Context/labels.txt',
                           '/home/tairuichen/Documents/PASCAL-Context/59_labels.txt',
                           '',
                           '/home/tairuichen/Documents/PASCAL-Context/',
                           val_list=val_list
                           )
